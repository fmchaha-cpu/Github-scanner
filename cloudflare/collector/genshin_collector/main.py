...
async def run(config_path: str):
    ...
    if _version_major_minor(worker_version) != expected_worker:
        raise SystemExit(
            ...
            "Deploy scripts/deploy_v08.ps1 first."
        )
    ...
    await api.start_scan(scan_id, __version__, notes="scheduled collector v0.8 hydration+historical-intelligence+deployment-handshake")
